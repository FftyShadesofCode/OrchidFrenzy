  ...
  return (
    <div className='flex items-center justify-center h-screen'>
      <form className='w-full max-w-lg' onSubmit={handleSubmit}>
        ...
        <div className={`gap-4 mt-10 flex items-center justify-center`}>
          <button
            onClick={signInWithGoogle}
            className={`p-4 w-[50%] text-gray-800 font-medium rounded-lg flex justify-center align-center gap-2 border-2 border-gray-400 hover:bg-gray-300 hover:border-gray-400`}
          >
