...
const Sidenav = () => {
    ...
    return (
        <div className={`transition-all duration-500 fixed right-0 mr-[25px] mb-[25px] mt-16 rounded-2xl border-2 border-primaryPurple border-md bg-gradient-to-tl from-darkPurple to-teal text-white h-[80vh] ${showSidebar ? 'w-72' : 'w-20'}`}>
