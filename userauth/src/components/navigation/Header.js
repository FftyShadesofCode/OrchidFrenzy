...
const Header = () => {
    ...
    return (
        <div className={`transition-all duration-500 fixed left-0 ml-[25px] mb-[25px] mt-[7.5rem] pb-10 rounded-2xl border-2 border-primaryPurple border-md bg-gradient-to-tl from-darkPurple to-teal text-white h-auto duration-300 ${showSidebar ? 'w-72' : 'w-20'}`}>
